  ...
  <MDBCol col='12'>
    ...
    <MDBCard className='bg-dark text-white my-5 mx-auto' style={{borderRadius: '1rem', maxWidth: '400px'}}>
      <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
        ...
        <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-white' label='Email address'  name="email" type='email' size="lg" />
        ...
        <div>
        <MDBBtn className='fw-bold mx-2 px-5'  size='lg' style={{ visibility: 'visible' }} type="submit" >
                    Login
        </MDBBtn>
        </div>
